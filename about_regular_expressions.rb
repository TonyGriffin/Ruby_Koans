...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # Researched materials werent very clear, must raise this question!
  end
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    ...
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # Careful, when using capital letters the opposite occurs. 
    # So for 
    # \d you get all digits but 
    # \D will give you anything but digits.
  end
  ...
  def test_caret_anchors_to_the_start_of_lines
    ...
    # !!!!!!!!!!!!!!!!!!!!!!!!!!
    # Attaches to the start of the line that begins with a digit??
  end
