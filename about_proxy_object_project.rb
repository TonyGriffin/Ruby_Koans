...
class Proxy
  ...
  def called?(method_name)
    ...
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # Does the array of messages contain the method that's given in the argument?
  end

  def number_of_times_called(method_name)
    @messages.count method_name
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # Count how many times the method given in the argumnet is called
  end

  def method_missing(method_name,  *args, &block)
    if @object.respond_to? method_name then
      # track each method called that the target object (TV) can respond to
