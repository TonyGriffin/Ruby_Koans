...
class AboutSymbols < Neo::Koan
  ...
  def test_identical_symbols_are_a_single_internal_object
    ...
    # only once during a session of ruby.
  end
  ...
  # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  # Because all methods have a symbol equivalent
  # So, if you were to gather all of the symbols defined so far into an array, you would need to convert them to strings first before comparing them.
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      # !!!!!!!!!!!!!!!!!!!!!!!!!
      # Dont really understand this one yet?
    end
  end
