...
class AboutClassMethods < Neo::Koan
  ...
  # Are there times you might prefer one over the other?
    ...
    # I personally prefer the first way, it's much clearer. I always separate my class and instance methods, so differentiation is not a problem. 

   # I like to define my class 
   # methods separately from my instance ones which also helps make that difference clear so I'm not concerned about def statements looking similar. I just don't find the latter very clear.
