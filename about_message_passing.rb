...
#  Longer answer:
#  If you really need send to behave like it would normally do, you should use __send__, because it won't (it shouldn't) be overriden. 
# Using __send__ is especially useful in metaprogramming, when you don't know what methods the class being manipulated defines. It could have overriden send.
 ...
 # end
  ...
  class MessageCatcher
    def add_a_payload(*args)
     ...
     # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     # NOTE: This is a usage of the splat operator, which converts a set of parameters into an array containing all parameters.
  end
  ...
  # NOTE:
  #
  # Both obj.msg and obj.send(:msg) sends the message named :msg to the object. 
  # We use "send" when the name of the message can vary dynamically (
  # e.g. calculated at run time), but by far the most common way of sending a message is just to say: obj.msg.
